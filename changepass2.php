...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['updatepass'])){
     $updatepass= $user-> updatePassword2($userid,$_POST);
}
...
<br>
     ...
     <div class="panel panel-default">
     	<div class="panel-heading">
               <h2>Change password<span class="pull-right"><a class="btn btn-primary" href="profile2.php?id=<?php echo $userid; ?>">Back</a></span></h2>
          </div>
